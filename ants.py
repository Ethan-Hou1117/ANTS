...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        for _ in range(self.lower_bound):
            ...
            x = x.entrance
            count += 1
        while (x.bees == [] and x.is_hive != True and count <= self.upper_bound): 
            x = x.entrance
            count += 1
        if (x.is_hive or count > self.upper_bound): return None
        return random_bee(x.bees)  # REPLACE THIS LINE
        # END Problem 3 and 4
...
class ContainerAnt(Ant):
    ...
    def action(self, gamestate):
        # BEGIN Problem 8a
        if self.ant_contained != None: self.ant_contained.action(gamestate)
        # END Problem 8a
...
# END Problem 12
    ...
    def construct(cls, gamestate):
        ...
        """
        # BEGIN Problem 12
        if gamestate.queen_exists == False:
